                ...
                <div class="flex flex-col md:flex-row">
                    <div class="h-32 md:h-auto md:w-1/2">
                        <img class="object-cover w-full h-full rounded"
                            src="https://i.pinimg.com/564x/ef/f1/84/eff1846d72fa82ad7a7dc6487aba32ea.jpg" alt="img" />
                    </div>
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div class="w-full">
                            <h3 class="mb-4 text-xl font-bold text-black-600">Make Reservation</h3>
                            ...
                            <form method="POST" action="{{ route('reservations.store.res.form') }}">
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <span class="text-xs">Please choose the time between 09:00-17:00.</span>
                                    @error('res_date')
                                        <div class="text-sm text-red-400">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="sm:col-span-6 pt-5">
                                    <label for="status" class="block text-sm font-medium text-gray-700">Service Selection</label>
                                    <div class="mt-1">
                                ...
                                <div class="mt-6 p-4 flex justify-center">
                                    <button type="submit"
                                        class="px-4 py-2 bg-black hover:bg-gray-200 rounded-lg text-white">Make
                                        Reservation</button>
                                </div>
