<x-guest-layout>
    ...
    style="background-image: url('https://img.freepik.com/free-photo/top-view-make-up-brushes-white-background_23-2148210689.jpg?w=2000')">
    <h1
        class="font-mono text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-blue-500 md:text-center sm:leading-none lg:text-5xl">
        <span class="inline md:block">Welcome To Beauty Studio</span>
    </h1>
    
    <div class="flex flex-col items-center mt-12 text-center">
        <span class="relative inline-flex w-full md:w-auto">
            <a href="{{ route('reservations.step.one') }}" type="button"
                class="inline-flex items-center justify-center px-6 py-2 text-base font-bold leading-6 text-white bg-pink-600 rounded-full lg:w-full md:w-auto hover:bg-pink-500 focus:outline-none">
        ...
        > -->
            ...
            <div class="w-full md:w-1/2">
                <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                    <img src="https://www.thepostoakhotel.com/img/wellness/salon-hero-7.jpg" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="flex flex-wrap items-center -mx-3">
            <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                <div class="w-full lg:max-w-md">
                    ...
                    <h2
                        class="mb-4 text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-blue-500">
                        WHY CHOOSE US?</h2>
...
<section class="pt-4 pb-12 bg-gray-800">
    <div class="my-16 text-center">
        <h2 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-blue-500">
            Testimonial </h2>
    ...
    <div class="grid gap-2 lg:grid-cols-3">
        <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
            <div class="flex justify-center -mt-16 md:justify-end">
                <img class="object-cover w-20 h-20 border-2 border-pink-500 rounded-full"
            ...
            <div class="flex justify-end mt-4">
                <a href="#" class="text-xl font-medium text-pink-500">John Doe</a>
            </div>
        </div>
        <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
            <div class="flex justify-center -mt-16 md:justify-end">
